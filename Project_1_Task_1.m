...
dataDir = 'I:/ASU/Fall 2015/CEN 502 Computer Systems II/Projects/P1/Code/Large_Dataset/with_landmask';

%%% R Threshold
R_THRESH = 0.90;

%%% Super Nodes XLS File
SuperNodes_XLS_File = ['SuperNodes_Task_1_R_', num2str(R_THRESH), '.xls'];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
